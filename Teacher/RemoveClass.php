...
if (isset($_POST['submit'])) {
  ...
  echo "<script>
    ...
    window.location.href = 'RemoveClass.php';
    </script>";
  exit();
  ...
  <div class="container-fluid">
    <div class="row">
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
        <div class="position-sticky pt-3 sidebar-sticky">
          ...
          <ul class="nav flex-column mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="./RemoveClass.php">
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 my-3">
        ...
        <h2 class="mb-5">Remove Class</h2>
        <h6 class="mb-4">Select the class to be deleted:
        </h6>
              ...
              <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                  <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Remove This Class?</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    Removing this class will cause all of its data to be deleted permanently. This includes all of its
                    attendance records. Are you sure that you want to remove this class?
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                    <button name="submit" type="submit" class="btn btn-primary">Yes, Remove it</button>
                  </div>
